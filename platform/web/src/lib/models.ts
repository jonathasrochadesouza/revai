...
export const PROVIDER_CATALOGUE: ProviderCatalogue[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    models: [
      ...
      { id: "anthropic/claude-opus-4.1", label: "Claude Opus 4.1", note: "highest quality" },
      { id: "anthropic/claude-haiku-4.5", label: "Claude Haiku 4.5", note: "fast and cheap" },
      { id: "openai/gpt-5.2", label: "GPT-5.2" },
      { id: "openai/gpt-5.2-codex", label: "GPT-5.2 Codex", note: "tuned for code" },
      { id: "openai/o4-mini", label: "o4-mini", note: "reasoning, low cost" },
      { id: "google/gemini-3-pro", label: "Gemini 3 Pro", note: "very large context" },
  ...
  },
  {
    ...
    models: [
      ...
      { id: "claude-opus-4-1", label: "Claude Opus 4.1", note: "highest quality" },
      { id: "claude-haiku-4-5", label: "Claude Haiku 4.5", note: "fast and cheap" },
    ],
  },
  {
    id: "openai",
    ...
    allowsCustomModel: true,
    models: [
      { id: "gpt-5.2-codex", label: "GPT-5.2 Codex", note: "tuned for code", recommended: true },
      { id: "gpt-5.2", label: "GPT-5.2" },
      { id: "gpt-5.2-mini", label: "GPT-5.2 mini", note: "cheaper" },
  ...
  },
  {
    ...
    models: [
      ...
      { id: "gemini-3-flash-lite", label: "Gemini 3 Flash Lite", note: "cheapest" },
    ],
  },
  {
    id: "ollama",
