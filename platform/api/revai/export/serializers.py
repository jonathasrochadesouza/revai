...
def render_sarif(review: Review, project: Project | None) -> bytes:
    """Emit SARIF 2.1.0 for CI systems and code-hosting integrations."""
    rules: dict[str, dict[str, Any]] = {}
    results: list[dict[str, Any]] = []
    for finding in review.sorted_findings:
        rule_id = finding.rule_id or f"revai/{finding.category.value}"
        rules.setdefault(
            rule_id,
            {
                "id": rule_id,
                ...
                "help": {"text": finding.rationale or finding.description},
                "properties": {
            ...
            "runs": [
                {
                    ...
                    "automationDetails": {"id": review.id},
                    "originalUriBaseIds": {
                        "SRCROOT": {
                            "uri": (
