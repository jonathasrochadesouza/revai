...
def get_skill_repository(settings: SettingsDep) -> SkillRepository:
    return SkillRepository(settings)
...
SkillRepo = Annotated[SkillRepository, Depends(get_skill_repository)]
